...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', type=str,
                        help='Challenge plaintext file input name.', default="files/m_c.txt")
    ...
    plaintext_c = read_file(fn = args.m).encode()
    ...
    #Encrypting the challenge plaintext
    nonce_c, ctxt_c = encryptor_CTR(message=plaintext_c, key=bitstring_to_bytes(main_key))
    write_bytes(fn = "files/c_c.bin", value = ctxt_c)
    write_bytes(fn = "files/nonce_c.bin", value = nonce_c)    
